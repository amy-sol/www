		...
		<div id="login_form">
			 ...
			 <div id="login2">
				<div id="id_input_button">
					<fieldset>
                        <input type="text" name="name" id="name" placeholder="이름 (ex. 홍길동)">
                        <input type="text" name="id" id="id" placeholder="아이디 (ex. test)">
                        <div class="telBox">
                            ...
                            <input class="find_input" type="text" id="hp2" name="hp2" title="연락처 가운데4자리를 입력하세요." maxlength="4" placeholder="(ex. 1111)" required> ㅡ
                            <label class="hidden" for="hp3">연락처 마지막4자리</label>
                            <input class="find_input" type="text" id="hp3" name="hp3" title="연락처 마지막4자리를 입력하세요." maxlength="4" placeholder="(ex. 2222)" required>
                        </div>
